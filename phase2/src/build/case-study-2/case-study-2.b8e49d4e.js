 ...
 */ const $726eb3bc0084efc9$var$SAFE_URL_PATTERN = /^(?:(?:https?|mailto|ftp|tel|file|sms):|[^#&/:?]*(?:[#/?]|$))/i;
/**
 * A pattern that matches safe data URLs. Only matches image, video and audio types.
 *
 * Shoutout to Angular https://github.com/angular/angular/blob/12.2.x/packages/core/src/sanitization/url_sanitizer.ts
 */ const $726eb3bc0084efc9$var$DATA_URL_PATTERN = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[\d+/a-z]+=*$/i;
const $726eb3bc0084efc9$var$allowedAttribute = (attribute, allowedAttributeList)=>{
    const attributeName = attribute.nodeName.toLowerCase();
    if (allowedAttributeList.includes(attributeName)) {
        if ($726eb3bc0084efc9$var$uriAttributes.has(attributeName)) return Boolean($726eb3bc0084efc9$var$SAFE_URL_PATTERN.test(attribute.nodeValue) || $726eb3bc0084efc9$var$DATA_URL_PATTERN.test(attribute.nodeValue));
        return true;
    }
...
function $726eb3bc0084efc9$export$c0fc46c8edd7094a(unsafeHtml, allowList, sanitizeFn) {
    ...
    for(let i = 0, len = elements.length; i < len; i++){
        ...
        attributeList.forEach((attribute)=>{
            if (!$726eb3bc0084efc9$var$allowedAttribute(attribute, allowedAttributes)) element.removeAttribute(attribute.nodeName);
        });
    }
...
const $73adddcf05fce0cb$var$DATA_KEY = "bs.tooltip";
const $73adddcf05fce0cb$var$EVENT_KEY = `.${$73adddcf05fce0cb$var$DATA_KEY}`;
const $73adddcf05fce0cb$var$CLASS_PREFIX = "bs-tooltip";
...
const $73adddcf05fce0cb$var$Event = {
    HIDE: `hide${$73adddcf05fce0cb$var$EVENT_KEY}`,
    HIDDEN: `hidden${$73adddcf05fce0cb$var$EVENT_KEY}`,
    SHOW: `show${$73adddcf05fce0cb$var$EVENT_KEY}`,
    SHOWN: `shown${$73adddcf05fce0cb$var$EVENT_KEY}`,
    INSERTED: `inserted${$73adddcf05fce0cb$var$EVENT_KEY}`,
    CLICK: `click${$73adddcf05fce0cb$var$EVENT_KEY}`,
    FOCUSIN: `focusin${$73adddcf05fce0cb$var$EVENT_KEY}`,
    FOCUSOUT: `focusout${$73adddcf05fce0cb$var$EVENT_KEY}`,
    MOUSEENTER: `mouseenter${$73adddcf05fce0cb$var$EVENT_KEY}`,
    MOUSELEAVE: `mouseleave${$73adddcf05fce0cb$var$EVENT_KEY}`
};
...
const $73adddcf05fce0cb$var$HOVER_STATE_SHOW = "show";
const $73adddcf05fce0cb$var$HOVER_STATE_OUT = "out";
 ...
 */ class $73adddcf05fce0cb$var$Tooltip extends (0, $5b3598292f163e3e$export$2e2bcd8739ae039) {
    ...
    static get Event() {
        return $73adddcf05fce0cb$var$Event;
    }
    static get DefaultType() {
    ...
    toggle(event) {
        ...
        if (event) {
            ...
            if (this.getTipElement().classList.contains($73adddcf05fce0cb$var$CLASS_NAME_SHOW)) {
    ...
    show() {
        ...
        const showEvent = (0, $3426e80176c401dc$export$2e2bcd8739ae039).trigger(this._element, this.constructor.Event.SHOW);
        ...
        if (this.constructor.NAME === "tooltip" && this.tip && this.getTitle() !== this.tip.querySelector($73adddcf05fce0cb$var$SELECTOR_TOOLTIP_INNER).innerHTML) {
            this._disposePopper();
            this.tip.remove();
            this.tip = null;
        }
        const tip = this.getTipElement();
        const tipId = (0, $e210a887c6468aad$export$6d2b3473b0986646)(this.constructor.NAME);
        tip.setAttribute("id", tipId);
        this._element.setAttribute("aria-describedby", tipId);
        if (this._config.animation) tip.classList.add($73adddcf05fce0cb$var$CLASS_NAME_FADE);
        const placement = typeof this._config.placement === "function" ? this._config.placement.call(this, tip, this._element) : this._config.placement;
        const attachment = this._getAttachment(placement);
        this._addAttachmentClass(attachment);
        const { container: container  } = this._config;
        (0, $ac46495d46cde4d0$export$2e2bcd8739ae039).set(tip, this.constructor.DATA_KEY, this);
        if (!this._element.ownerDocument.documentElement.contains(this.tip)) {
            container.append(tip);
            (0, $3426e80176c401dc$export$2e2bcd8739ae039).trigger(this._element, this.constructor.Event.INSERTED);
        }
        if (this._popper) this._popper.update();
        else this._popper = $864a452899cad2a6$exports.createPopper(this._element, tip, this._getPopperConfig(attachment));
        ...
        if ("ontouchstart" in document.documentElement) [].concat(...document.body.children).forEach((element)=>{
            (0, $3426e80176c401dc$export$2e2bcd8739ae039).on(element, "mouseover", (0, $e210a887c6468aad$export$8793edee2d425525));
        });
        const complete = ()=>{
            const prevHoverState = this._hoverState;
            this._hoverState = null;
            (0, $3426e80176c401dc$export$2e2bcd8739ae039).trigger(this._element, this.constructor.Event.SHOWN);
            if (prevHoverState === $73adddcf05fce0cb$var$HOVER_STATE_OUT) this._leave(null, this);
        };
        const isAnimated = this.tip.classList.contains($73adddcf05fce0cb$var$CLASS_NAME_FADE);
    ...
    hide() {
        ...
        const complete = ()=>{
            ...
            if (this._hoverState !== $73adddcf05fce0cb$var$HOVER_STATE_SHOW) tip.remove();
            this._cleanTipClass();
            this._element.removeAttribute("aria-describedby");
            (0, $3426e80176c401dc$export$2e2bcd8739ae039).trigger(this._element, this.constructor.Event.HIDDEN);
            this._disposePopper();
        };
        const hideEvent = (0, $3426e80176c401dc$export$2e2bcd8739ae039).trigger(this._element, this.constructor.Event.HIDE);
        if (hideEvent.defaultPrevented) return;
        tip.classList.remove($73adddcf05fce0cb$var$CLASS_NAME_SHOW);
        // If this is a touch-enabled device we remove the extra
        // empty mouseover listeners we added for iOS support
        if ("ontouchstart" in document.documentElement) [].concat(...document.body.children).forEach((element)=>(0, $3426e80176c401dc$export$2e2bcd8739ae039).off(element, "mouseover", (0, $e210a887c6468aad$export$8793edee2d425525)));
    ...
    setContent(tip) {
        this._sanitizeAndSetContent(tip, this.getTitle(), $73adddcf05fce0cb$var$SELECTOR_TOOLTIP_INNER);
    }
    ...
    setElementContent(element, content) {
        ...
        if ((0, $e210a887c6468aad$export$45a5e7f76e0caa8d)(content)) {
            content = (0, $e210a887c6468aad$export$d16800b7e59a8051)(content);
        ...
        if (this._config.html) {
            if (this._config.sanitize) content = (0, $726eb3bc0084efc9$export$c0fc46c8edd7094a)(content, this._config.allowList, this._config.sanitizeFn);
    ...
    _getAttachment(placement) {
        return $73adddcf05fce0cb$var$AttachmentMap[placement.toUpperCase()];
    }
    _setListeners() {
        const triggers = this._config.trigger.split(" ");
        triggers.forEach((trigger)=>{
            if (trigger === "click") (0, $3426e80176c401dc$export$2e2bcd8739ae039).on(this._element, this.constructor.Event.CLICK, this._config.selector, (event)=>this.toggle(event));
            else if (trigger !== $73adddcf05fce0cb$var$TRIGGER_MANUAL) {
                const eventIn = trigger === $73adddcf05fce0cb$var$TRIGGER_HOVER ? this.constructor.Event.MOUSEENTER : this.constructor.Event.FOCUSIN;
                const eventOut = trigger === $73adddcf05fce0cb$var$TRIGGER_HOVER ? this.constructor.Event.MOUSELEAVE : this.constructor.Event.FOCUSOUT;
                (0, $3426e80176c401dc$export$2e2bcd8739ae039).on(this._element, eventIn, this._config.selector, (event)=>this._enter(event));
                (0, $3426e80176c401dc$export$2e2bcd8739ae039).on(this._element, eventOut, this._config.selector, (event)=>this._leave(event));
            }
        });
    ...
    _enter(event, context) {
        ...
        if (event) context._activeTrigger[event.type === "focusin" ? $73adddcf05fce0cb$var$TRIGGER_FOCUS : $73adddcf05fce0cb$var$TRIGGER_HOVER] = true;
        if (context.getTipElement().classList.contains($73adddcf05fce0cb$var$CLASS_NAME_SHOW) || context._hoverState === $73adddcf05fce0cb$var$HOVER_STATE_SHOW) {
            context._hoverState = $73adddcf05fce0cb$var$HOVER_STATE_SHOW;
            return;
        }
        ...
        context._timeout = setTimeout(()=>{
            if (context._hoverState === $73adddcf05fce0cb$var$HOVER_STATE_SHOW) context.show();
        }, context._config.delay.show);
    }
    _leave(event, context) {
        context = this._initializeOnDelegatedTarget(event, context);
        if (event) context._activeTrigger[event.type === "focusout" ? $73adddcf05fce0cb$var$TRIGGER_FOCUS : $73adddcf05fce0cb$var$TRIGGER_HOVER] = context._element.contains(event.relatedTarget);
        if (context._isWithActiveTrigger()) return;
        clearTimeout(context._timeout);
        context._hoverState = $73adddcf05fce0cb$var$HOVER_STATE_OUT;
        if (!context._config.delay || !context._config.delay.hide) {
            context.hide();
            return;
        }
        context._timeout = setTimeout(()=>{
            if (context._hoverState === $73adddcf05fce0cb$var$HOVER_STATE_OUT) context.hide();
    ...
    _getConfig(config) {
        ...
        Object.keys(dataAttributes).forEach((dataAttr)=>{
            if ($73adddcf05fce0cb$var$DISALLOWED_ATTRIBUTES.has(dataAttr)) delete dataAttributes[dataAttr];
        });
        config = {
            ...this.constructor.Default,
            ...dataAttributes,
        ...
        (0, $e210a887c6468aad$export$a0f7579b69cdb6e1)($73adddcf05fce0cb$var$NAME, config, this.constructor.DefaultType);
        if (config.sanitize) config.template = (0, $726eb3bc0084efc9$export$c0fc46c8edd7094a)(config.template, config.allowList, config.sanitizeFn);
        return config;
    }
    _getDelegateConfig() {
        const config = {};
    ...
    _getBasicClassPrefix() {
        return $73adddcf05fce0cb$var$CLASS_PREFIX;
    }

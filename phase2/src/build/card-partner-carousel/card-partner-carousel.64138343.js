...
parcelRequire.register("2nx7g", function(module, exports) {
/*!
...
parcelRequire.register("9vV8n", function(module, exports) {
/*
 ...
 */ (function(e, t) {
    ...
    function r(e) {
        ...
        return i && "BODY" !== i && "HTML" !== i ? -1 !== [
            "TD",
            "TABLE"
        ].indexOf(o.nodeName) && "static" === t(o, "position") ? r(o) : o : e ? e.ownerDocument.documentElement : document.documentElement;
    }
    function p(e) {
        var t = e.nodeName;
    ...
    function Y(e, t) {
        Object.keys(t).forEach(function(o) {
            ...
            -1 !== [
                ...
                "bottom",
                "left"
            ].indexOf(o) && U(t[o]) && (i = "px"), e.style[o] = t[o] + i;
        });
    }
    function j(e, t) {
        Object.keys(t).forEach(function(o) {
    ...
    function G(e, t) {
        ...
        return o = U(+i) ? [
            +i,
            0
        ] : z(i, p, s, d), "left" === d ? (p.top += o[0], p.left -= o[1]) : "right" === d ? (p.top += o[0], p.left += o[1]) : "top" === d ? (p.left += o[0], p.top -= o[1]) : "bottom" === d && (p.left += o[0], p.top += o[1]), e.popper = p, e;
    }
    ...
    return fe.Utils = ("undefined" == typeof window ? $parcel$global : window).PopperUtils, fe.placements = de, fe.Defaults = {
        placement: "bottom",
        eventsEnabled: !0,
        removeOnDestroy: !1,
        onCreate: function() {},
        ...
        modifiers: {
            ...
            keepTogether: {
                ...
                enabled: !0,
                fn: function(e) {
                    var t = e.offsets, o = t.popper, i = t.reference, n = e.placement.split("-")[0], r = X, p = -1 !== [
                        "top",
                        "bottom"
            ...
            arrow: {
                ...
                fn: function(e, o) {
                    ...
                    var r = e.placement.split("-")[0], p = e.offsets, s = p.popper, d = p.reference, a = -1 !== [
                        "left",
                        "right"
                    ].indexOf(r), l = a ? "height" : "width", f = a ? "Top" : "Left", m = f.toLowerCase(), h = a ? "left" : "top", g = a ? "bottom" : "right", u = L(n)[l];
            ...
            flip: {
                ...
                fn: function(e, t) {
                    ...
                    return p.forEach(function(s, d) {
                        ...
                        var a = e.offsets.popper, l = e.offsets.reference, f = X, m = "left" === i && f(a.right) > f(l.left) || "right" === i && f(a.left) < f(l.right) || "top" === i && f(a.bottom) > f(l.top) || "bottom" === i && f(a.top) < f(l.bottom), h = f(a.left) < f(o.left), c = f(a.right) > f(o.right), g = f(a.top) < f(o.top), u = f(a.bottom) > f(o.bottom), b = "left" === i && h || "right" === i && c || "top" === i && g || "bottom" === i && u, w = -1 !== [
                            "top",
                            "bottom"
                        ].indexOf(i), y = !!t.flipVariations && (w && "start" === r && h || w && "end" === r && c || !w && "start" === r && g || !w && "end" === r && u);
...
!function(t, e) {
    e($e2a90cc60d351e5f$exports, (parcelRequire("2nx7g")), (parcelRequire("9vV8n")));
}($e2a90cc60d351e5f$exports, function(t, g, u) {
    "use strict";
    function i(t, e) {

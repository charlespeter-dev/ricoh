...
})({"cJ534":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "b18079269770a63b";
...
},{}],"5zED0":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _dropdown = require("../../../node_modules/bootstrap/js/src/dropdown");
var _tooltip = require("../../../node_modules/bootstrap/js/src/tooltip");
var _tooltipDefault = parcelHelpers.interopDefault(_tooltip);
let copyEl = document.querySelector(".copy-link");
let toolTip = new (0, _tooltipDefault.default)(copyEl);
...
},{"../../../node_modules/bootstrap/js/src/dropdown":"eHbBp","../../../node_modules/bootstrap/js/src/tooltip":"hUPFI","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}],"eHbBp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"ipIak":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./createPopper.js":"5xmeL","./modifiers/eventListeners.js":"hc74C","./modifiers/popperOffsets.js":"5huhg","./modifiers/computeStyles.js":"1WauU","./modifiers/applyStyles.js":"7iSwa","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}],"lyX8s":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}],"hUPFI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
 * --------------------------------------------------------------------------
...
const Default = {
    ...
    sanitize: true,
    sanitizeFn: null,
    allowList: (0, _sanitizer.DefaultAllowlist),
    popperConfig: null
};
const Event = {
    HIDE: `hide${EVENT_KEY}`,
 ...
 * Class Definition
 * ------------------------------------------------------------------------
 */ class Tooltip extends (0, _baseComponentDefault.default) {
    constructor(element, config){
    ...
    dispose() {
        ...
        (0, _eventHandlerDefault.default).off(this._element.closest(SELECTOR_MODAL), EVENT_MODAL_HIDE, this._hideModalHandler);
    ...
    show() {
        ...
        const showEvent = (0, _eventHandlerDefault.default).trigger(this._element, this.constructor.Event.SHOW);
        const shadowRoot = (0, _index.findShadowRoot)(this._element);
        ...
        const tipId = (0, _index.getUID)(this.constructor.NAME);
        tip.setAttribute("id", tipId);
        this._element.setAttribute("aria-describedby", tipId);
        if (this._config.animation) tip.classList.add(CLASS_NAME_FADE);
        const placement = typeof this._config.placement === "function" ? this._config.placement.call(this, tip, this._element) : this._config.placement;
        const attachment = this._getAttachment(placement);
        this._addAttachmentClass(attachment);
        const { container  } = this._config;
        (0, _dataDefault.default).set(tip, this.constructor.DATA_KEY, this);
        if (!this._element.ownerDocument.documentElement.contains(this.tip)) {
            container.append(tip);
            (0, _eventHandlerDefault.default).trigger(this._element, this.constructor.Event.INSERTED);
        }
        if (this._popper) this._popper.update();
        ...
        if ("ontouchstart" in document.documentElement) [].concat(...document.body.children).forEach((element)=>{
            (0, _eventHandlerDefault.default).on(element, "mouseover", (0, _index.noop));
        });
        const complete = ()=>{
            const prevHoverState = this._hoverState;
            this._hoverState = null;
            (0, _eventHandlerDefault.default).trigger(this._element, this.constructor.Event.SHOWN);
    ...
    hide() {
        ...
        const complete = ()=>{
            ...
            (0, _eventHandlerDefault.default).trigger(this._element, this.constructor.Event.HIDDEN);
            this._disposePopper();
        };
        const hideEvent = (0, _eventHandlerDefault.default).trigger(this._element, this.constructor.Event.HIDE);
        if (hideEvent.defaultPrevented) return;
        tip.classList.remove(CLASS_NAME_SHOW);
        // If this is a touch-enabled device we remove the extra
        // empty mouseover listeners we added for iOS support
        if ("ontouchstart" in document.documentElement) [].concat(...document.body.children).forEach((element)=>(0, _eventHandlerDefault.default).off(element, "mouseover", (0, _index.noop)));
    ...
    _sanitizeAndSetContent(template, content, selector) {
        const templateElement = (0, _selectorEngineDefault.default).findOne(selector, template);
    ...
    setElementContent(element, content) {
        ...
        if ((0, _index.isElement)(content)) {
            content = (0, _index.getElement)(content);
        ...
        if (this._config.html) {
            if (this._config.sanitize) content = (0, _sanitizer.sanitizeHtml)(content, this._config.allowList, this._config.sanitizeFn);
    ...
    _setListeners() {
        ...
        triggers.forEach((trigger)=>{
            if (trigger === "click") (0, _eventHandlerDefault.default).on(this._element, this.constructor.Event.CLICK, this._config.selector, (event)=>this.toggle(event));
            else if (trigger !== TRIGGER_MANUAL) {
                const eventIn = trigger === TRIGGER_HOVER ? this.constructor.Event.MOUSEENTER : this.constructor.Event.FOCUSIN;
                const eventOut = trigger === TRIGGER_HOVER ? this.constructor.Event.MOUSELEAVE : this.constructor.Event.FOCUSOUT;
                (0, _eventHandlerDefault.default).on(this._element, eventIn, this._config.selector, (event)=>this._enter(event));
                (0, _eventHandlerDefault.default).on(this._element, eventOut, this._config.selector, (event)=>this._leave(event));
            }
        });
        this._hideModalHandler = ()=>{
            if (this._element) this.hide();
        };
        (0, _eventHandlerDefault.default).on(this._element.closest(SELECTOR_MODAL), EVENT_MODAL_HIDE, this._hideModalHandler);
    ...
    _getConfig(config) {
        const dataAttributes = (0, _manipulatorDefault.default).getDataAttributes(this._element);
        ...
        (0, _index.typeCheckConfig)(NAME, config, this.constructor.DefaultType);
        if (config.sanitize) config.template = (0, _sanitizer.sanitizeHtml)(config.template, config.allowList, config.sanitizeFn);
        return config;
    }
    _getDelegateConfig() {
        const config = {};
...
},{"@popperjs/core":"dWtQP","./util/index":"lyX8s","./util/sanitizer":"8iTUL","./dom/data":"6cC82","./dom/event-handler":"a63ez","./dom/manipulator":"BMF5o","./dom/selector-engine":"2TEBH","./base-component":"kSsKw","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}],"8iTUL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "DefaultAllowlist", ()=>DefaultAllowlist);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}]},["cJ534","5zED0"], "5zED0", "parcelRequire2f87")

...
$comp_meta = [
    'banner' => [
        ...
        'class' => [
            'banner' => '.banner',
            'lp-banner' => '.lp-banner',
            'lp-banner-cta' => '.lp-banner',
            'lp-banner-cisco' => '.lp-banner-cisco'
        ],
        'iframe' => [
            'banner' => [
                'url' => sprintf('%s/banner/banner.html', GH_BUILD_URL),
                'width' => '100%',
                'height' => '500px'
            ],
            'lp-banner' => [
                'url' => sprintf('%s/lp-banner/lp-banner.html', GH_BUILD_URL),
                'width' => '100%',
                'height' => '500px'
            ],
            'lp-banner-cta' => [
                'url' => sprintf('%s/lp-banner-cta/lp-banner-cta.html', GH_BUILD_URL),
                'width' => '100%',
                'height' => '500px'
            ],
            'lp-banner-cisco' => [
                'url' => sprintf('%s/lp-banner-cisco/lp-banner-cisco.html', GH_BUILD_URL),
                'width' => '100%',
                'height' => '500px'
            ]
        ]
                    ...
                    <div class="container">
                        ...
                        <nav>
                            <div class="nav nav-tabs nav-justified">
                                ...
                                <div class="nav-link">
                                    <span><a href="<?= $components['iframe'][$dir]['url'] ?>" target="_blank">LIVE DEMO</a></span>
                                </div>
                            </div>
                        </nav>

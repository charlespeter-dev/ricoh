 ...
 */ class $b53d16494e490efd$var$Tab extends (0, $5b3598292f163e3e$export$2e2bcd8739ae039) {
    ...
    _activate(element, relatedElem) {
        ...
        this._activate((0, $e210a887c6468aad$export$4a2866eb97cae207)(element)) // Search and activate/show the proper section
        ;
        const complete = ()=>{
    ...
    _deactivate(element, relatedElem) {
        ...
        element.blur();
        this._deactivate((0, $e210a887c6468aad$export$4a2866eb97cae207)(element)) // Search and deactivate the shown section too
        ;
        const complete = ()=>{
            if (element.getAttribute("role") !== "tab") {
    ...
    _keydown(event) {
        ...
        const nextActiveElement = (0, $e210a887c6468aad$export$7bc25e2173fc3d1f)(this._getChildren().filter((element)=>!(0, $e210a887c6468aad$export$30e0dc115df457ed)(element)), event.target, isNext, true);
    ...
    _setInitialAttributesOnTargetPanel(child) {
        const target = (0, $e210a887c6468aad$export$4a2866eb97cae207)(child);
        if (!target) return;

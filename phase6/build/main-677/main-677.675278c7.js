...
/**
 * Constants
 */ const $5b3598292f163e3e$var$VERSION = '5.3.7';
/**
 * Class definition
 ...
 */ class $fbab61ae9aa23ff0$var$Dropdown extends (0, $5b3598292f163e3e$export$2e2bcd8739ae039) {
    ...
    _createPopper() {
        if (typeof $864a452899cad2a6$exports === 'undefined') throw new TypeError('Bootstrap\'s dropdowns require Popper (https://popper.js.org/docs/v2/)');
 ...
 */ class $73adddcf05fce0cb$var$Tooltip extends (0, $5b3598292f163e3e$export$2e2bcd8739ae039) {
    constructor(element, config){
        if (typeof $864a452899cad2a6$exports === 'undefined') throw new TypeError('Bootstrap\'s tooltips require Popper (https://popper.js.org/docs/v2/)');
        super(element, config);
        // Private
    ...
    _setListeners() {
        ...
        for (const trigger of triggers){
            if (trigger === 'click') (0, $3426e80176c401dc$export$2e2bcd8739ae039).on(this._element, this.constructor.eventName($73adddcf05fce0cb$var$EVENT_CLICK), this._config.selector, (event)=>{
                ...
                context._activeTrigger[$73adddcf05fce0cb$var$TRIGGER_CLICK] = !(context._isShown() && context._activeTrigger[$73adddcf05fce0cb$var$TRIGGER_CLICK]);
                context.toggle();
            });

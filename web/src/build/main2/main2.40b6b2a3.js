...
$parcel$export(module.exports, "getSelectorFromElement", () => $e210a887c6468aad$export$2a298c6a007e5e40);
$parcel$export(module.exports, "getElementFromSelector", () => $e210a887c6468aad$export$4a2866eb97cae207);
$parcel$export(module.exports, "triggerTransitionEnd", () => $e210a887c6468aad$export$201d3c8336a47e6c);
...
$parcel$export(module.exports, "typeCheckConfig", () => $e210a887c6468aad$export$a0f7579b69cdb6e1);
...
function $129e89498f274122$export$2e2bcd8739ae039(state, options) {
    if (options === void 0) options = {};
    var _options = options, placement1 = _options.placement, boundary = _options.boundary, rootBoundary = _options.rootBoundary, padding = _options.padding, flipVariations = _options.flipVariations, _options$allowedAutoP = _options.allowedAutoPlacements, allowedAutoPlacements = _options$allowedAutoP === void 0 ? (0, $d33c9c04e83a0fb3$export$803cd8101b6c182b) : _options$allowedAutoP;
    var variation = (0, $55d412c966f7cc47$export$2e2bcd8739ae039)(placement1);
...
function $b8ee520e10aec899$var$flip(_ref) {
    ...
    for(var i = 0; i < placements.length; i++){
        ...
        var _basePlacement = (0, $0f2f0199dbc7c8d3$export$2e2bcd8739ae039)(placement1);
        var isStartVariation = (0, $55d412c966f7cc47$export$2e2bcd8739ae039)(placement1) === (0, $d33c9c04e83a0fb3$export$b3571188c770cc5a);
        var isVertical = [
            (0, $d33c9c04e83a0fb3$export$1e95b668f3b82d),
            (0, $d33c9c04e83a0fb3$export$40e543e69a8b3fbb)
...
function $cf1303c32e82a4d1$export$7fa02d8595b015ed(placement, rects, offset1) {
...
function $cf1303c32e82a4d1$var$offset(_ref2) {
    ...
    var data = (0, $d33c9c04e83a0fb3$export$803cd8101b6c182b).reduce(function(acc, placement) {
        acc[placement] = $cf1303c32e82a4d1$export$7fa02d8595b015ed(placement, state.rects, offset2);
        return acc;
    }, {});
...
function $df51816adb601187$export$ed5e13716264f202(generatorOptions) {
    ...
    return function createPopper(reference1, popper1, options1) {
        ...
        var instance = {
            ...
            setOptions: function setOptions(setOptionsAction) {
                ...
                state1.scrollParents = {
                    reference: (0, $eefe3e69c9d92426$export$45a5e7f76e0caa8d)(reference1) ? (0, $326acd9f31c3f47e$export$2e2bcd8739ae039)(reference1) : reference1.contextElement ? (0, $326acd9f31c3f47e$export$2e2bcd8739ae039)(reference1.contextElement) : [],
                    popper: (0, $326acd9f31c3f47e$export$2e2bcd8739ae039)(popper1)
                }; // Orders the modifiers based on their dependencies and `phase`
                // properties
                var orderedModifiers = (0, $281a952d89382bf1$export$2e2bcd8739ae039)((0, $e5ceb015ff30ccab$export$2e2bcd8739ae039)([].concat(defaultModifiers, state1.options.modifiers))); // Strip out disabled modifiers
            ...
            forceUpdate: function forceUpdate() {
                ...
                state1.rects = {
                    reference: (0, $5dc83d2c5e53f266$export$2e2bcd8739ae039)(reference, (0, $35c8e64b545245be$export$2e2bcd8739ae039)(popper), state1.options.strategy === "fixed"),
        ...
        if (!$df51816adb601187$var$areValidElements(reference1, popper1)) return instance;
 ...
 */ class $fbab61ae9aa23ff0$var$Dropdown extends (0, $7Pvka.default) {
    ...
    show() {
        if ((0, $jpl1o.isDisabled)(this._element) || this._isShown(this._menu)) return;
        const relatedTarget = {
        ...
        if (this._inNavbar) (0, $dEVUr.default).setDataAttribute(this._menu, "popper", "none");
        else this._createPopper(parent);
        // If this is a touch-enabled device we add extra
        // empty mouseover listeners to the body's immediate children;
        // only needed because of broken event delegation on iOS
        // https://www.quirksmode.org/blog/archives/2014/02/mouse_event_bub.html
        if ("ontouchstart" in document.documentElement && !parent.closest($fbab61ae9aa23ff0$var$SELECTOR_NAVBAR_NAV)) [].concat(...document.body.children).forEach((elem)=>(0, $4tBqP.default).on(elem, "mouseover", (0, $jpl1o.noop)));
        this._element.focus();
    ...
    _completeHide(relatedTarget) {
        ...
        if ("ontouchstart" in document.documentElement) [].concat(...document.body.children).forEach((elem)=>(0, $4tBqP.default).off(elem, "mouseover", (0, $jpl1o.noop)));
        if (this._popper) this._popper.destroy();
    ...
    _getConfig(config) {
        ...
        (0, $jpl1o.typeCheckConfig)($fbab61ae9aa23ff0$var$NAME, config, this.constructor.DefaultType);
    ...
    _createPopper(parent) {
        ...
        if (isDisplayStatic) (0, $dEVUr.default).setDataAttribute(this._menu, "popper", "static");
    }
    _isShown(element = this._element) {
        return element.classList.contains($fbab61ae9aa23ff0$var$CLASS_NAME_SHOW);
    }
    _getMenuElement() {
        return (0, $6aLfT.default).next(this._element, $fbab61ae9aa23ff0$var$SELECTOR_MENU)[0];
    }
    _getPlacement() {
    ...
    _selectMenuItem({ key: key , target: target  }) {
        const items = (0, $6aLfT.default).find($fbab61ae9aa23ff0$var$SELECTOR_VISIBLE_ITEMS, this._menu).filter((0, $jpl1o.isVisible));
    ...
    static clearMenus(event) {
        ...
        const toggles = (0, $6aLfT.default).find($fbab61ae9aa23ff0$var$SELECTOR_DATA_TOGGLE);
    ...
    static getParentFromElement(element) {
        return (0, $jpl1o.getElementFromSelector)(element) || element.parentNode;
    }
    static dataApiKeydownHandler(event) {
        ...
        const getToggleButton = this.matches($fbab61ae9aa23ff0$var$SELECTOR_DATA_TOGGLE) ? this : (0, $6aLfT.default).prev(this, $fbab61ae9aa23ff0$var$SELECTOR_DATA_TOGGLE)[0];
